...
global wave2 "$data/wave_2"
cap{
	mkdir "$data/wave_2/merged_data2"
}
global merged_data "$data/wave_2/merged_data2"

**Creating a log file
set logtype smcl
log using "$do/nepal_earthquake_2.smcl", replace
...
*save the dataset--------------------------------*
save "$wave2/section_5a.dta", replace

*************************----------------------------***************************
*----------------------Using Dataset Section_5(b) Dataset----------------------*
*************************----------------------------***************************

use "$raw_data_2/Section_5b.dta"
...
save "$wave2/section_5b.dta", replace

*************************----------------------------***************************
*----------------------Merging Dataset 5(a) and 5(b)---------------------------*
*************************----------------------------***************************
use "$wave2/section_5a.dta"

merge m:1 hhid using "$wave2/section_5b.dta"
drop _merge
...
*************************----------------------------***************************
use "$raw_data_2/Section_6a.dta"
*renaming the variables***
rename s06q01a value_month
rename s06q01b value_year
*Saving the dataset--------------------------------*
save "$wave2/section_6(a)", replace

*************************----------------------------***************************
*----------------------Using Dataset Section_6(b) Dataset----------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_6b.dta"
*renaming the variables***
rename s06q02 infreq_exp_year
*saving the dataset--------------------------------*
save "$wave2/section_6(b)", replace

*************************----------------------------***************************
*----------------------Using Dataset Section_6(c) Dataset----------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_6c.dta"
*renaming the variables***
rename s06q03a num_item
rename s06q03b value_item
*saving the dataset--------------------------------*
save "$wave2/section_6(c)", replace

*************************----------------------------***************************
*----------------------Using Dataset Section_6(d) Dataset----------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_6d.dta"
*renaming the variables***
rename s06q04a self_own_item
rename s06q04b self_amt_month 
rename s06q04c self_amt_year
*saving the dataset--------------------------------*
save "$wave2/section_6(d)", replace

*************************----------------------------***************************
*-------------------Merging 6(a) 6(b) 6(c) and 6(d) datasets-------------------*
*************************----------------------------***************************

use "$wave2/section_6(a).dta"
append using "$wave2/section_6(b).dta"
save "$wave2/section_6(a_b).dta", replace

use "$wave2/section_6(a_b).dta"
append using "$wave2/section_6(c).dta"
save "$wave2/section_6(a_b_c).dta", replace
use "$wave2/section_6(d).dta"
merge 1:m hhid using "$wave2/section_6(a_b_c).dta"
drop _merge
...
*************************----------------------------***************************
use "$raw_data_2/Section_9a1.dta"
*rename the variables***
...
*saving the dataset--------------------------------*
save "$wave2/section_9a1.dta", replace

*************************----------------------------***************************
*------------------------Using Dataset Section_9(a2).dta---------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9a2.dta"
*rename the variables***
...
*save the dataset--------------------------------*
save "$wave2/section_9a2.dta", replace

*************************----------------------------***************************
*------------------------Using Dataset Section_9(a3).dta---------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9a3.dta"
*rename the variables***
...
*Saving dataset--------------------------------*
save "$wave2/section_9a3.dta", replace

*************************----------------------------***************************
*------------------------Using Dataset Section_9(a4).dta---------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9a4.dta"
*rename variables***
...
*save the dataset--------------------------------*
save "$wave2/section_9a4.dta", replace

*************************----------------------------***************************
*------------------------Merging dataset section_9a1-9a4-----------------------*
*************************----------------------------***************************
use "$wave2/section_9a1.dta"
append using "$wave2/section_9a2.dta"
save "$wave2/section_9a1_2.dta", replace

use "$wave2/section_9a3.dta"
merge 1:1 hhid using "$wave2/section_9a4.dta"
drop _merge
save "$wave2/section_9a3_4.dta", replace

use "$wave2/section_9a3_4.dta"
merge 1:m hhid using "$wave2/section_9a1_2.dta", keep (match master)
drop _merge
sort hhid
save "$wave2/section_9a1_4.dta", replace
*************************----------------------------***************************
*------------------------Using Dataset Section_9(b1).dta-----------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9b1.dta"
*rename variables***
...
*Save the dataset--------------------------------*
save "$wave2/section_9b1.dta", replace

*************************----------------------------***************************
*------------------------Using Dataset Section_9(b2).dta---------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9b2.dta"
*rename variables***
...
*Save the dataset--------------------------------*
save "$wave2/section_9b2.dta", replace
*************************----------------------------***************************
*-------------------Appending Dataset Section_9(b1)_9(b2)------------------------*
*************************----------------------------***************************
use "$wave2/section_9b2.dta"
append using "$wave2/section_9b1.dta"
sort hhid
save "$wave2/section_9b1_2.dta", replace
*************************----------------------------***************************
*------------------------Using Dataset Section_9(c).dta------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9c.dta"
*rename variables***
...
*Save the dataset--------------------------------*
save "$wave2/section_9c.dta", replace

*************************----------------------------***************************
*------------------------Using Dataset Section_9(d).dta---------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9d.dta"
*rename variables***
...
*save dataset--------------------------------*
save "$wave2/section_9d.dta", replace

*************************----------------------------***************************
*------------------------Using Dataset Section_9(e).dta---------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9e.dta"
...
*Save Dataset----------------------*
save "$wave2/section_9e.dta", replace

*************************----------------------------***************************
*------------------------Using Dataset Section_9(f).dta---------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_9f.dta"
*Rename Variables
...
*Save dataset--------------------------------*
save "$wave2/section_9f.dta", replace

*************************----------------------------***************************
*------------------------Merging datasets 9(a) to 9(f)-------------------------*
*************************----------------------------***************************

use "$wave2/section_9e.dta"
merge 1:1 hhid using "$wave2/section_9c.dta", keep(match using)
drop _merge
save "$wave2/section_9e_c.dta", replace
merge 1:m hhid using "$wave2/section_9a1_4.dta"
drop _merge
save "$wave2/section_9a_e_c.dta", replace
merge m:m hhid using "$wave2/section_9b1_2.dta", keep(match master)
drop _merge
save "$wave2/section_9ac_9b12.dta", replace
use "$wave2/section_9d.dta"
merge m:m hhid using "$wave2/section_9d.dta", keep(match master)
drop _merge
save "$wave2/section_9ac_9b12_9d.dta", replace

merge m:m hhid using "$wave2/section_9f.dta", keep(match master)
drop _merge
save "$merged_data/farming_livestock.dta", replace
*************************----------------------------***************************
*------------------------Use Dataset Section_10.dta----------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_10.dta"
*Rename Variables
...
rename s11q06a_s  second_job_type_other
...
rename s11q02b_s other_specific
...
*************************----------------------------***************************
use "$raw_data_2/Section_12a.dta"
*Rename Variables
...
*Saving Dataset----------------------*
save "$wave2/section_12a.dta", replace

*************************----------------------------***************************
*------------------------Use Dataset Section_12(b).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_12b.dta"
*Rename Variables
...
*Saving Dataset----------------------*
save "$wave2/section_12b.dta", replace

*************************----------------------------***************************
*------------------------Use Dataset Section_12(c).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_12c.dta"
*Rename Variables
rename s12q23 value_asset
rename s12q24 recvd_sources

*Saving Dataset----------------------*
save "$wave2/section_12c.dta", replace
*************************----------------------------***************************
*------------------------Use Dataset Section_12(d).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_12d.dta"
*Rename Variables
...
*Saving Dataset----------------------*
save "$wave2/section_12d.dta", replace
*************************----------------------------***************************
*----------------------Merging datsets in section 12(a-d)----------------------*
*************************----------------------------***************************

use "$wave2/section_12c.dta"
merge m:1 hhid using "$wave2/section_12d.dta", keep(match using)
drop _merge
save "$wave2/section_12cd.dta", replace
use "$wave2/section_12cd.dta"
use "$wave2/section_12b.dta"
merge m:m hhid using "$wave2/section_12a.dta"
drop _merge
save "$wave2/section_12ab.dta", replace
use "$wave2/section_12ab.dta"
merge m:m hhid using "$wave2/section_12cd.dta", keep(match using)
drop _merge
...
*************************----------------------------***************************
use "$raw_data_2/Section_13a.dta"
...
*Saving Dataset----------------------*
save "$wave2/section_13a.dta", replace

*************************----------------------------***************************
*------------------------Use Dataset Section_13(b).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_13b.dta"
...
*Saving Dataset----------------------*
save "$wave2/section_13b.dta", replace

*************************----------------------------***************************
*------------------------Use Dataset Section_13(c).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_13c.dta"
*Rename variables*********
rename s13q18b name_ingos
rename s13q19a amt_assistance
rename s13q19b item_type_kind
...
*Saving dataset--------------------------------*
save "$wave2/section_13c.dta", replace

*************************----------------------------***************************
*------------------------Use Dataset Section_13(d).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_13d.dta"
...
*Saving the dataset--------------------------------*
save "$wave2/section_13d.dta", replace
*************************----------------------------***************************
*------------------------Mergig Dataset with section 13------------------------*
*************************----------------------------***************************

//use "$data/section_13a.dta"
use "$wave2/section_13b.dta"
use "$wave2/section_13c.dta"
use "$wave2/section_13d.dta"
merge 1:m hhid using "$wave2/section_13c.dta", keep(match master)
drop _merge
save "$wave2/section_13cd.dta", replace

merge m:m hhid using  "$wave2/section_13b.dta", keep(match master)
drop _merge
save "$wave2/section_13cdb.dta", replace

merge m:m hhid using "$wave2/section_13a.dta", keep(match master)
drop _merge
...
*************************----------------------------***************************
use "$raw_data_2/Section_14a.dta"
...
rename s14q05_s assisted_other_specify
...
rename s14q06e_s other_prblm_spec
...
rename s14q09i suggsn_transfer

*Saving Dataset----------------------*
save "$wave2/section_14a.dta", replace

*************************----------------------------***************************
*------------------------Use Dataset Section_14(b).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_14b.dta"
*Renaming variables********************
...
*Saving Dataset-------------------------*
save "$wave2/section_14b.dta", replace

*************************----------------------------***************************
*------------------------Use Dataset Section_14(c).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_14c.dta"
...
*Saving Dataset-------------------------*
save "$wave2/section_14c.dta", replace


*************************----------------------------***************************
*------------------------Merge Dataset for section 14--------------------------*
*************************----------------------------***************************
use "$wave2/section_14a.dta"
merge m:m hhid using "$wave2/section_14b.dta", keep (match master)
drop _merge
save "$wave2/section_14ab.dta", replace
merge m:m hhid using "$wave2/section_14c.dta"
drop _merge
...
*************************----------------------------***************************
use "$raw_data_2/Section_15a.dta"
*Renaming Variables***********************
...
rename s15q10f_s other_asstnce_spec
...
rename s15q07_s other_spec2
rename s15q08_s other_spec4
rename s15q11_s other_spec5

*Saving the Dataset----------------------*
save "$wave2/section_15a.dta", replace

*************************----------------------------***************************
*------------------------Use Dataset Section_15(b).dta-------------------------*
*************************----------------------------***************************
use "$raw_data_2/Section_15b.dta"
*Renaming Variables***********************
...
*Saving the dataset--------------------------------*
save "$wave2/section_15b.dta", replace

*************************----------------------------***************************
*------------------------Merge dataset 15a and 15b-----------------------------*
*************************----------------------------***************************
use "$wave2/section_15a.dta"
merge m:1  hhid using "$wave2/section_15b.dta", keep (match using)
drop _merge
...
save "$merged_data/wave_2.dta", replace
